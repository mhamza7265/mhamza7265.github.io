function Card({ icon, title, description }) {
  return (
    <div className="service-card mt-10 sm:mt-0 w-11/12 sm:w-3/4 mx-auto sm:mx-8 max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
